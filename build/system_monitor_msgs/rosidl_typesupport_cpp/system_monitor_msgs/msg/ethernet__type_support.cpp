...
static const _Ethernet_type_support_symbol_names_t _Ethernet_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, system_monitor_msgs, msg, Ethernet)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, system_monitor_msgs, msg, Ethernet)),
  }
};
...
{
  return &::system_monitor_msgs::msg::rosidl_typesupport_cpp::Ethernet_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, system_monitor_msgs, msg, Ethernet)() {
  return get_message_type_support_handle<system_monitor_msgs::msg::Ethernet>();
}
